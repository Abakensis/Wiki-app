 ...
 */
 ...
 const showResults = results => {
     results.forEach(result => {
         resultsContainer.innerHTML += `
         <div class="results__item card  m-1">

      
            
         <div class="card-body">
           <a href="https://en.wikipedia.org/?curid=${result.pageId}" target="_blank" class="card animated bounceInUp"></a>
  <h4 class="results__item__title">${result.title}</h4>
                 <p class="results__item__intro p-0">${result.intro}</p>
         </div>
